          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
            <div className="flex-1 text-left space-y-4 animate-fade-up max-w-3xl">
              <div className="space-y-3">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black tracking-[0.05em] md:tracking-[0.1em] leading-[0.9] uppercase text-white font-display text-left">
                  comunicação <br />
